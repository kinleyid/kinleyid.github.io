  ...
  class jsPsychHtmlVasResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      var full_diam = { // Full diameters, accounting for border widths
        ...
        'right': trial.right_diam + 2*trial.left_border_width
      }
      // Create HTML
      ...
      for (side in both_circles) {
        ...
        // Create the title and possibly arrow
        var title_sep = Math.abs(full_diam[side] - full_diam[side_opposites[side]])/2 + 10;
        var arrow;
        if (trial.arrows) {
          arrow =
            '<div style="' + 
              'position: absolute; height: 2px;' + 
              'border-top: ' + full_border_cmd + ';' +
              'width: ' + title_sep + 'px;' +
              side + ': 100%;' +
        ...
        var title = '<div id="jspsych-ios-' + side + '-circle-title"' + 'style="' + 
          'position: absolute;' +
          'height:' + full_diam[side] + 'px;' +
          'line-height:' + full_diam[side] + 'px;' +
          'margin-' + side_opposites[side] + ': ' + title_sep + 'px;' +
      ...
      // Create a clickable area the doesn't include the circle titles
